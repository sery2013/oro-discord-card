function generateCard() {
    ...
    if (avatarInput.files[0]) {
        ...
        reader.onload = function (e) {
            drawAvatarFrame();
            // Обрезка аватара строго внутри рамки
            ctx.save();
            ctx.beginPath();
    ...
    function drawLogoAndQR() {
        ...
        // QR КОД (Поднят на 15px: было 255, стало 240)
        const qrSize = 120;
        const qrY = 240; 
        ...
        ctx.textAlign = "center";
        ctx.fillText("Scan to visit", 80, qrY - 7);
        ctx.fillText("getoro.xyz", 80, qrY + qrSize + 15);
        ctx.textAlign = "start";
    }
}
